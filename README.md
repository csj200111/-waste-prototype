...
대형폐기물 수수료 조회, 온라인/오프라인 배출 신청, 나눔 커뮤니티, AI 폐기물 판독, 재활용 물품 게시판을 제공하는 모바일 우선 웹 서비스입니다.
...
| 6 | 재활용 물품 게시판 | 물품 사진 업로드 + 등록/관리/삭제 | ✓ |
...
| 재활용 물품 | `GET/POST /api/recycle/items` | 물품 목록 / 등록 |
